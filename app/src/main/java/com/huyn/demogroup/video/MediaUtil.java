...
public class MediaUtil {
     ...
     */
    public boolean extractMedia(String path, String outPath, boolean isMedia) {
    ...
    public boolean combineMedia(String inputVideoPath, String inputAudioPath, String outPath) {
        ...
        try {
            ...
            Log.e(TAG, "combineMedia audioTrack " + audioTrack);
            Log.e(TAG, "combineMedia videoTrack " + videoTrack);
    ...
    public void convertToAccIfNeeded(String input, final String output, final OnAudioConvertListener listener) {
        try {
            ...
            if (input.endsWith(".mp3")) {
                ...
                audioCodec.setIOPath(input, output);
                audioCodec.prepare();
     ...
     */
    private boolean convertToAcc(MediaFormat trackFormat, String input, String output) {
        try {
    ...
    private long getSampleTime(MediaExtractor mediaExtractor, ByteBuffer byteBuffer, int videoTrack) {
        ...
        //Log.e(TAG, "getSampleTime is " + sampleTime);
