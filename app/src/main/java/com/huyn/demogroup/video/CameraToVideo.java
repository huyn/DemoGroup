...
public class CameraToVideo {
    private static final String TAG = "CameraToVideo";
    private static final boolean VERBOSE = true;           // lots of logging

    // where to put the output file (note: /sdcard requires WRITE_EXTERNAL_STORAGE permission)
    private static final File OUTPUT_DIR = new File(Environment.getExternalStorageDirectory(), "/testvideo");

    // parameters for the encoder
    private static final String MIME_TYPE = "video/avc";    // H.264 Advanced Video Coding
    private static final int FRAME_RATE = 20;               // 30fps
    private static final int IFRAME_INTERVAL = 5;           // 5 seconds between I-frames
    private static final long DURATION_SEC = 3;             // 8 seconds of video
    ...
    private static class CameraToMpegWrapper implements Runnable {
        ...
        private CameraToVideo mTest;

        private CameraToMpegWrapper(CameraToVideo test) {
            mTest = test;
        }
        ...
        /** Entry point. */
        public static void runTest(CameraToVideo obj) throws Throwable {
            CameraToMpegWrapper wrapper = new CameraToMpegWrapper(obj);
            Thread th = new Thread(wrapper, "codec test");
            th.start();
            // TODO fellow codes would make project not work
            /*th.join();
    ...
    private void encodeCameraToMpeg() throws IOException {
        ...
        try {
            ...
            while (System.nanoTime() < desiredEnd) {
                System.out.println("++++++loop " + System.nanoTime() + "/" + desiredEnd);
...
//                }
            ...
            System.out.println("++++++loop end " + System.nanoTime() + "/" + desiredEnd);
    ...
    private void drainEncoder(boolean endOfStream) {
        ...
        System.out.println("++++++drainEncoder.start " + endOfStream);
        ...
        while (true) {
            ...
            if (encoderStatus == MediaCodec.INFO_TRY_AGAIN_LATER) {
                ...
                System.out.println("++++++drainEncoder.addtrack");
                ...
                if (mBufferInfo.size != 0) {
                    ...
                    System.out.println("++++++drainEncoder.writedata");
    ...
    private static class SurfaceTextureManager
        ...
        private CameraToVideo.STextureRender mTextureRender;
        ...
        public SurfaceTextureManager() {
            mTextureRender = new CameraToVideo.STextureRender();
        ...
        public void awaitNewImage() {
            ...
            System.out.println("+++++awaitNewImage..." + mFrameAvailable);
...
//                            System.out.println("+++++error.1");
            ...
            System.out.println("+++++awaitNewImage.success");
            // Latch the data.
